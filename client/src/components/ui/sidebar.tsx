...
const SIDEBAR_WIDTH_ICON = "4rem" // Increased from 3rem for better visibility
...
>(
  (
    ...
    const initialState = cookies[SIDEBAR_COOKIE_NAME] === "false" ? false : defaultOpen
    ...
    // Helper to toggle the sidebar with animation
